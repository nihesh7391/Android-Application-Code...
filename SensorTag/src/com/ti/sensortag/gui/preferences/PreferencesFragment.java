...
public class PreferencesFragment extends PreferenceFragment implements PropertyChangeListener {
 ...
 // BluetoothDevice device ;
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    button.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
      ...
      public boolean onPreferenceClick(Preference arg0) {
        ...
        test = device.getAddress().substring(device.getAddress().lastIndexOf(':') + 1);
        Toast.makeText(getActivity(), "ARV addr PF:"+test, Toast.LENGTH_SHORT).show();
  ...
  public void propertyChange(PropertyChangeEvent event) {
    ...
    //  BluetoothDevice device = ((PreferencesActivity) getActivity()).getDevice();
    //  Toast.makeText(getActivity(), "ARV Addr:"+device.getAddress(), Toast.LENGTH_SHORT).show();
      final Intent intent = new Intent(activity, ServicesActivity.class).putExtra("TEST", test);
